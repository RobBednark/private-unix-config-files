...
DirQuizMeRun=~/quizme-read-only-run
...
alias cdquizme-run="cd $DirQuizMeRun; workon quizme"
...
alias vq="git.commit.all.modified.and.new.for.repo.of.given.file $DirAddToQuizme/learn_add_to_quizme; vim $DirAddToQuizme/learn_add_to_quizme  $DirQuizMeRun/db_dumps/latest.dump.txt; git.commit.all.modified.and.new.for.repo.of.given.file $DirAddToQuizme/learn_add_to_quizme"
alias vquizmedb-second-file="vim  $DirQuizMeRun/db_dumps/latest.dump.txt"
