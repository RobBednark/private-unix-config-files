...
alias docker-rm-all-containers='docker rm $(docker ps --all --quiet)'
alias docker-rm-all-images='docker rmi $(docker images --all --quiet) --force' # remove all images
alias docker-rm-all-images-and-containers='docker-stop-and-rm-all-containers; docker-rm-all-images; docker container ls -a; docker images ls -a'
...
alias docker-stop-and-rm-all-containers='docker-stop-all-containers; docker-rm-all-containers'
