...
DirQuizMeProd=~/quizme-read-only-prod
...
alias cddjango-last="cd $DirDropbox/bin/learn/dir.learn.django.projects/learn_django_auth_email_usernames"
...
alias cdcatalog-docker="cd $DirMoovelReposDocker/gamma-catalog"
...
alias cdfare-catalogs-gateway-verve-test="cd $DirMoovelReposGamma/gateway-verve-test"
alias cdmonorepo="cd $DirMoovelReposAll/monorepo"
alias cdna-git-hooks="cd $DirMoovelReposGamma/na-git-hooks"
alias cdproduct="cd $DirMoovelReposGamma/gamma-product"
alias cdrbednark-fare-catalogs="cd ~/repos.rob/rbednark-fare-catalogs"
...
alias git.log.commit.message.first.line.only='git --no-pager log --format=%s -n 1'
...
alias rq='cdquizme-prod ; DB_QUIZME=quizme_production QM_INCLUDE_UNANSWERED=True QM_SORT_BY_ANSWERED_COUNT=False QM_SORT_BY_WHEN_ANSWERED=False QM_DEBUG_PRINT=True pipenv shell python manage.py runserver'  # unanswered first ("rq" = "run quiz")
alias rqr='cdquizme-prod ; DB_QUIZME=quizme_production QM_INCLUDE_UNANSWERED=False QM_SORT_BY_ANSWERED_COUNT=False QM_SORT_BY_WHEN_ANSWERED=True  QM_DEBUG_PRINT=True pipenv shell python manage.py runserver'  # unanswered last  ("rqr" = "run quiz, reinforce")
