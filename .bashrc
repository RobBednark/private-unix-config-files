...
alias docker-rm-all-containers='docker rm $(docker ps --all --quiet); docker ps -a'
alias docker-rm-all-images='docker rmi $(docker images --all --quiet) --force; docker images -a' # remove all images
alias docker-rm-all-images-and-containers='docker-stop-and-rm-all-containers; docker-rm-all-images'
