...
alias   vquizmedb="vim $DirQuizMe/db_dumps/latest.dump.txt $DirLearn/learn_add_to_quizme"
...
alias vstocks="vici $FileStocks $FileStockNotes $DirQuiz/db_stocks_options"
