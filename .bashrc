...
# database / db
alias   cddbagency="cd $DirReposMoovelGamma/db-agency"
alias   cddbbaseschema="cd $DirReposMoovelGamma/db-base-schema"
...
alias curl-catalog-products-verve="curl 'https://bart-dev.gslabs.us/v2/catalog/products' -H 'content-type: application/json; charset=utf-8'  -H 'x-gs-scope: bart-dev'"
alias curl-catalog-products-verve-cors="curl 'https://bart-dev.gslabs.us/v2/catalog/products' -H 'Origin: https://rbednark.gslabs.us' -H 'content-type: application/json; charset=utf-8' -H 'Referer: https://verve-dev.gslabs.us/bart' -H 'x-gs-scope: bart-dev'"
alias curl-catalog-product-id-verve="curl 'https://bart-dev.gslabs.us/v2/catalog/product/1' -H 'content-type: application/json; charset=utf-8'  -H 'x-gs-scope: bart-dev'"
