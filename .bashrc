...
alias   trapit.psql.higgs="psql -h db-4 --username=zoidberg -W --dbname=trapit"
...
alias   tail.time="tail -5 $FilePingSymlinkActive; tail -99f $FilePingSymlinkActive | grep SUMMARY:.time"
