...
alias   tail.time="head -5 $FilePingSymlinkActive; tail -99f $FilePingSymlinkActive | grep SUMMARY:.time"
...
alias   vquizmedb="cd $DirQuizMe/db_dumps; vim $(ls -1tr $DirQuizMe/db_dumps/*txt | tail -1)"
