...
#alias curl-catalog-products-verve="curl 'https://bart-dev.gslabs.us/v2/catalog/products' -H 'Origin: https://verve-dev.gslabs.us' -H 'content-type: application/json; charset=utf-8' -H 'Referer: https://verve-dev.gslabs.us/bart' -H 'x-gs-scope: bart-dev'"
alias curl-catalog-products-verve="curl 'https://bart-dev.gslabs.us/v2/catalog/products' -H 'Origin: https://verve-dev.gslabs.us' -H 'content-type: application/json; charset=utf-8'  -H 'x-gs-scope: bart-dev'"
